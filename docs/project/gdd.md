...
| `Result` | TBD | 미구현 |
| 개발 HUD (Tab / F2) | 접속·트랜스포트 전환·가구 리셋(R) / 밸런스 튜닝 창 | 구현됨 (릴리스에서 제외 예정) |
...
최종 갱신: 2026-09-04 (일시정지 메뉴 **구현 완료** — 자동 테스트 통과, 수동 검증·D-1 대기. 조작키·UI 표와 개발 HUD 키 표기를 실제 값 Tab/F2 로 정정)
