...
- **두더지 스킬(탐지·굴착)** — 굴착은 R키·종료 조건 등 프로토타입 구현, 탐지 키·공통 판정 조건·쿨타임 수치 등은 여전히 미정 — [mole-skill-system.md](mole-skill-system.md)
...
| 테스트 | EditMode·PlayMode 테스트 어셈블리 운영. 최신 결과 EditMode 60/60, PlayMode 12/12 통과 |
...
- 두더지 스킬(탐지·굴착) 규칙: [mole-skill-system.md](mole-skill-system.md) — 초안
